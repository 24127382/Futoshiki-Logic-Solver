...
class BackwardChainingSolver:
	"""Small wrapper class for compatibility with class-based solver usage."""

	def solve(self, initial_state: State, kb: KnowledgeBase) -> Optional[State]:
		return backward_chaining_solver(initial_state, kb)
